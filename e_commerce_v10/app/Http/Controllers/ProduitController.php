...
{ 
    ...
    { 
        ...
        $cmd = DB::table('cmds')->where("val","=",0)->where("user_id","=",session()->get("id")[0]);
        $total=$cmd->count();
        return view('site.pro_sans',['produit'=>$listproduit,'total'=>$total,'color'=>$listcolor,'marque'=>$listmarque,'univer'=>$listUniver,'frma'=>$listForma_boitier]); 
    }
    ...
    { 
        ...
        return view('site.all_pr_categrie',['produit'=>$listproduit,'color'=>$listcolor,'marque'=>$listmarque,'univer'=>$listUniver,'frma'=>$listForma_boitier]);
    }
