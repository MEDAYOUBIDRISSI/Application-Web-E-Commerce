...
// Route::post('chartjs1','ChartController@chartnumber1');

Route::get('charts', 'ChartController@index')->name('chart.index');
 
Route::get('charts/data', 'ChartController@getdata');
Route::get('charts/data2', 'ChartController@getdata2');
...
Route::group(['prefix' => "admin"], function () {
    ...
    Route::get('/logins',function (){
        ...
        return view('dashbord.login_admin_simple');
    });
    Route::post('/logins','Sup_adminController@loginAdminSimpleTest');
    Route::get('/deconnexionsimple','Sup_adminController@DeconnexionSimpleAdmin');
...
Route::group(['prefix' => "cmd"], function () {
    Route::get('/admin','CmdController@indexcmd');
